...
namespace IG.Lib
{
    ...
    public abstract class ReporterConsoleMsgboxSpeech_Base : ReporterConsoleMsgbox_Base, IReporterSpeech
    {
        ...
        /// <summary>Delegate for launching a report via speech.</summary>
        ...
        protected static void DefaultReport_Speech(ReporterBase reporter, ReportType messagetype,
        ...
        protected static string DefaultReportLocation_Speech(ReporterBase reporter, ReportType messagetype,
        ...
        protected static string DefaultReportMessage_Speech(ReporterBase reporter, ReportType messagetype,
