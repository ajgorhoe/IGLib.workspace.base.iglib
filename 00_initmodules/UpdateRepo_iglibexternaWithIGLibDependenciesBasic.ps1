...
# After updating / cloning ../../iglibexternal/ , also update IGLib dependencirs
#   within ../../iglibexternal/IGLibExternal/ !

& $(Join-Path $scriptDir "../../iglibexternal/IGLibExternal/UpdateReposGroup_Dep_IGLib0MostBasic.ps1")
