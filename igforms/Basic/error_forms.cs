...
namespace IG.Forms
{
    ...
    public class ReporterForms :  ReporterBase // IG.Lib.Reporter
    {
        ...
        /// <summary>Default function function for reserve error reporting (called if an exception is thrown in an error reporting function):</summary>
        ...
        // $A Igor Oct08;
        {
            ...
            try
            {
                ...
                fm.MsgTitle = title;
                fm.MsgText = msg;
                fm.ShowThread(title, msg);
            }
            catch{}
            try
            {
                // Show the message in the global console consform:
                ConsoleForm cons = UtilForms.Console;
                if (cons != null)
                {
                    cons.Write(msg);
                }
        ...
        /// <summary>Delegat for launching a report via console consform.</summary>
