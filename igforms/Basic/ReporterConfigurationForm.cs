...
namespace IG.Forms
{
	...
	public class ReporterConfigurationForm : System.Windows.Forms.Form
    //$A Igor Oct08;
    {
        ...
        //private ReporterConfigurationForm() { }  // prevent calling argument-less constructor

        public ReporterConfigurationForm() : this(null)
        { }

        public ReporterConfigurationForm(ReporterForms rf)
        {
            InitializeComponent();
            if (rf == null)
                rf = new ReporterForms();
            reporter = rf;
            if (reporter == null)
    ...
    "and other kinds of reports are launched.";
            ...
            this.Name = "ReporterConfigurationForm";
