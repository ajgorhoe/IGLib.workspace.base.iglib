...
namespace IG.Forms
{
    ...
    /// </summary>
    /// 
    [Obsolete("Do not use this type, it will be removed soon.")]
    public class XMLTreeViewFormOld_Keep_Some_time : System.Windows.Forms.Form
    {
        ...
        // Launches an error report, string is the error message.
        {
            ...
            fm.Launch(true /* inParallelThread */ );
        }
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(XMLTreeViewFormOld_Keep_Some_time));
        ...
        void Main0()
        {
            Application.Run(new XMLTreeViewFormOld_Keep_Some_time());
        }
        ...
        private void XMLTreeView_Load(object sender, System.EventArgs e)
        {
            try
            {
                ...
                resources = new System.ComponentModel.ComponentResourceManager(typeof(XMLTreeViewFormOld_Keep_Some_time));
        ...
        */
        ...
        public static void Example()
        {
            //  XML TreeView Tests:
            Application.Run(new XMLTreeViewFormOld_Keep_Some_time());
            XMLTreeViewFormOld_Keep_Some_time tv;
            Environment.Exit(0);
            tv = new XMLTreeViewFormOld_Keep_Some_time();
            tv.ShowInTaskbar = true;     // Override the default setting
            tv.ShowDialog();

            XMLTreeViewFormOld_Keep_Some_time tv1;
            tv1 = new XMLTreeViewFormOld_Keep_Some_time();
            tv1.ShowDialog();
